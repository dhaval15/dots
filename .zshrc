...
export ZSH=/home/dhaval/.oh-my-zsh
...
alias redisplay="xrandr --output eDP1 --mode 1366x768 && nitrogen --restore"

alias emulator="$HOME/Dev/packages/android/emulator/emulator"
alias :q="exit"
alias :e="vim"
...
#eval "$(lua $HOME/scripts/packages/z.lua/z.lua --init zsh)"

# >>> conda initialize >>>
# !! Contents within this block are managed by 'conda init' !!
__conda_setup="$('/home/dhaval/conda/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/dhaval/conda/etc/profile.d/conda.sh" ]; then
        . "/home/dhaval/conda/etc/profile.d/conda.sh"
    else
        export PATH="/home/dhaval/conda/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
