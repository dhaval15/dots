...
bg_default = "#161616"          # main shade darkest
bg_lighter = "#282828"
bg_selection = "#d3869b"
# "#545862"
fg_disabled = "#565c64"
fg_default = "#fbf1c7"
fg_selection = bg_default
# "#b6bdca"
bg_lightest = "#c8ccd4"         # main shade lightest
fg_error = "#fb4934"            # red
# "#d19a66"                     # purple
bg_hint = "#fabd2f"             # yellow
fg_matched_text = "#b8bb26"     # green
bg_passthrough_mode = "#8ec07c" # teal
bg_insert_mode = "#83a598"      # blue
bg_warning = "#fe8019"          # orange
# "#be5046"                     # dark red
